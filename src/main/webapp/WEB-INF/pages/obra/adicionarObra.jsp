				...
				<tbody>
					<c:forEach var="obra" items="${obras}" >
						<tr>
						  	...
						  	<td> <img src="${obra.imagem}" style="height:42px;width:42px"></td>
						  	<td><a class="btn btn-primary" href="<c:url value="/museu/adicionarObra?obraId=${obra.id}&museuId=${museuId}" />" >Adicionar</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
